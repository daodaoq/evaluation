...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '6a12693a-28b0-11f1-b8c5-246db74e60f7:1-454';
...
INSERT INTO `evaluation_period` VALUES (1,'2026春季综测','2026-03-01 00:00:00','2026-07-31 23:59:59',1,0,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-26 05:53:29','2026-03-26 05:53:29'),(2,'2025-2026学年第一学期','2025-09-01 00:00:00','2026-01-31 23:59:59',1,0,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-27 19:27:01','2026-03-27 19:27:01');
...
CREATE TABLE `sys_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-28 10:29:17
