...
CREATE TABLE `evaluation_period` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='综测周期表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evaluation_rule` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='综测规则表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_permission` (
  ...
  `perm_type` tinyint NOT NULL COMMENT '权限类型（1菜单【仅使用此类型】 2按钮【暂不使用】 3接口【暂不使用】）',
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_permission` VALUES (1,'用户管理','sys:user:menu',1,0,1,1,'2026-03-16 16:20:34','2026-03-16 16:20:46'),(2,'角色管理','sys:role:menu',1,0,2,1,'2026-03-16 16:20:34','2026-03-16 16:20:46'),(3,'权限管理','sys:perm:menu',1,0,3,1,'2026-03-16 16:20:34','2026-03-16 16:20:46'),(4,'学生管理','sys:student:menu',1,0,4,1,'2026-03-16 16:20:34','2026-03-16 16:20:46'),(5,'规则分类管理','sys:category:menu',1,0,5,1,'2026-03-17 10:29:13','2026-03-17 10:29:14'),(6,'规则总览','sys:rule:menu',1,0,6,1,'2026-03-17 10:30:08','2026-03-17 10:30:10'),(7,'规则项管理','sys:item:menu',1,0,7,1,'2026-03-17 10:30:45','2026-03-17 10:30:46'),(16,'学院管理','sys:college:menu',1,0,8,1,'2026-03-21 13:18:05','2026-03-21 13:18:05'),(17,'班级管理','sys:class:menu',1,0,9,1,'2026-03-21 13:18:05','2026-03-21 13:18:05');
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,'admin','{bcrypt}$2a$10$ijC.UqIhDVWnFOFI9e8fPusbeffVvabJ279LQ1Etqvl4IwZedW0ge','admin',0,0,1,'2026-03-11 16:34:10','2026-03-14 16:03:11'),(2,'2023001','{bcrypt}$2a$10$ijC.UqIhDVWnFOFI9e8fPusbeffVvabJ279LQ1Etqvl4IwZedW0ge','张三',1,101,1,'2026-03-16 14:23:33','2026-03-17 11:35:40'),(3,'2023002','{bcrypt}$2a$10$ijC.UqIhDVWnFOFI9e8fPusbeffVvabJ279LQ1Etqvl4IwZedW0ge','李四',1,101,1,'2026-03-16 14:23:33','2026-03-17 11:35:40'),(4,'2023003','{bcrypt}$2a$10$ijC.UqIhDVWnFOFI9e8fPusbeffVvabJ279LQ1Etqvl4IwZedW0ge','管理员',2,NULL,1,'2026-03-16 14:23:33','2026-03-17 11:35:40');
...
INSERT INTO `sys_user_role` VALUES (1,1,3,'2026-03-16 14:23:34','2026-03-16 14:34:42'),(2,2,1,'2026-03-16 14:23:34','2026-03-16 14:34:42'),(3,3,2,'2026-03-16 14:23:34','2026-03-16 14:34:42'),(4,4,3,'2026-03-16 14:34:49','2026-03-16 14:34:50');
...
-- Dump completed on 2026-03-22 10:13:21
