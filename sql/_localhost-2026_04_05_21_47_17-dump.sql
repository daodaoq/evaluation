...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '6a12693a-28b0-11f1-b8c5-246db74e60f7:1-815';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生综测申报表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申报指标项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evaluation_apply_item` VALUES (1,1,27,0.00,'APPROVED','2026-04-01 11:22:50',NULL,NULL,NULL,NULL,NULL,'RULE',NULL),(2,2,30,0.80,'APPROVED','2026-04-01 22:21:07',NULL,NULL,NULL,NULL,NULL,'RULE',NULL),(3,3,110,0.10,'APPROVED','2026-04-03 22:04:44',NULL,NULL,NULL,NULL,'213123','RULE',NULL),(4,3,153,0.50,'APPROVED','2026-04-03 22:04:44',NULL,NULL,NULL,NULL,'8778','RULE',NULL),(5,4,159,0.00,'APPROVED','2026-04-03 22:09:27',NULL,NULL,NULL,NULL,NULL,'RULE',NULL),(6,5,31,0.50,'APPROVED','2026-04-03 22:10:12',NULL,NULL,NULL,NULL,NULL,'RULE',NULL),(7,6,198,1.00,'APPROVED','2026-04-05 18:54:55',NULL,NULL,NULL,NULL,'213213','RULE',NULL),(8,6,201,0.70,'APPROVED','2026-04-05 18:54:55',NULL,NULL,NULL,NULL,'213','RULE',NULL);
...
CREATE TABLE `evaluation_apply_material` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申报材料表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evaluation_apply_material` VALUES (1,1,'证明材料','123213123','2026-04-01 11:22:50'),(2,2,'123123','123','2026-04-01 22:21:07'),(3,3,'计算机科学与技术学院本科学生综合素质评价实施细则.pdf','apply-materials/5/3db9b5b2-4327-4c70-b949-5991079677f8_计算机科学与技术学院本科学生综合素质评价实施细则.pdf','2026-04-03 22:04:44'),(4,7,'附件2：2026年春季心理筛查学生操作说明.pdf','apply-materials/5/443bedd9-ddef-4fcf-8f58-007dcaf7da4e_附件2_2026年春季心理筛查学生操作说明.pdf','2026-04-05 18:54:55'),(5,8,'计算机科学与技术学院本科学生综合素质评价实施细则 (1) (2).pdf','apply-materials/5/449111ca-9e14-4cb9-a577-c75ab525f6f6_计算机科学与技术学院本科学生综合素质评价实施细则__1___2_.pdf','2026-04-05 18:54:55');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='审核记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=179 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-05 21:47:17
